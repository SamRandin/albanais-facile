import type { Word } from '@/data/lessons-no'
...
export default function NorwegianWordCard({ word, index }: Props) {
  return (
    <div className="bg-white rounded-2xl border border-blue-100 shadow-sm p-5 flex flex-col gap-3">
      {/* Index + Norwegian word */}
      <div className="flex items-start gap-3">
        <span className="flex-shrink-0 w-7 h-7 rounded-full bg-blue-100 text-blue-700 text-xs font-bold flex items-center justify-center mt-1">
          {index + 1}
        </span>
        <div>
      ...
      {/* Example phrase */}
      <div className="pl-10 bg-blue-50 rounded-xl p-3 border border-blue-100">
