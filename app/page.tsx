...
export default function HomePage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="bg-gradient-to-br from-amber-400 via-orange-400 to-amber-500 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm font-semibold mb-6">
              <span>🇦🇱</span>
              <span>Shqip — Langue albanaise</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-white/90 mb-8 leading-relaxed">
              ...
              découverte de l&apos;Albanie. Apprendre par thèmes, sans prise de
              tête.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                href="/#lecons"
                className="inline-flex items-center gap-2 bg-white text-amber-700 font-bold px-6 py-3 rounded-full shadow hover:bg-amber-50 transition-colors"
              >
      ...
      {/* CTA section */}
      <section className="bg-gradient-to-r from-amber-500 to-orange-500 text-white mt-4 mb-10 mx-4 sm:mx-6 rounded-3xl max-w-5xl lg:mx-auto">
        <div className="px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            href="/lecons/salutations"
            className="flex-shrink-0 bg-white text-amber-700 font-bold px-6 py-3 rounded-full shadow hover:bg-amber-50 transition-colors"
          >
            Première leçon →
          </Link>
        </div>
