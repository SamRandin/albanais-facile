...
export default function ElvishLessonCard({ lesson }: Props) {
  return (
    <Link
      href={`/elfique/${lesson.id}`}
      className="group block bg-white rounded-2xl border border-emerald-100 shadow-sm hover:shadow-md hover:border-emerald-300 transition-all duration-200 overflow-hidden"
    >
      {/* Color band at top */}
      <div className="h-2 bg-gradient-to-r from-emerald-400 to-emerald-600 group-hover:from-emerald-500 group-hover:to-emerald-700 transition-colors duration-200" />
